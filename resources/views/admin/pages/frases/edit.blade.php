...
@section('content')
    <div class="container">
        ...
        <div class="container">
            @include('admin.pages.frases.form._errors')

            <form method="post" action="{{ route('frases.update', $frase->id) }}">
                <input type="hidden" name="_method" value="put">
                @include('admin.pages.frases._form')
                <button type="submit" class="btn-create" style="background: white; margin: 20px 0; padding: 6px;">Enviar</button>
                <a href="{{route('frases.index')}}" class="btn-link">Voltar</a>
            </form>
        </div>
